...
**The main application file is `behavioral_maze_captcha.py`, NOT `production_maze_captcha.py`**
...
2. **Wrong File Being Modified**: When debugging, ensure you're working with:
   - `behavioral_maze_captcha.py` (actual production application)
   - NOT `production_maze_captcha.py` (alternative/test version)

3. **API Works But Site Doesn't**: If the API endpoints return 200 but the frontend shows errors:
